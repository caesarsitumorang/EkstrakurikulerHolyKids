...
<head>
  ...
  <link href="../../../ui/wali_kelas/css/style_dashboard_wali_kelas.css" rel="stylesheet" />
</head>
<body>
  <div class="main-wrapper">
    ...
    <div class="dashboard-container">
      <!-- Sidebar -->
      <div class="sidebar">
        <a id="menu-beranda" onclick="loadPage('beranda/beranda_wali_kelas.php', this)">Beranda</a>
        <a id="menu-siswa" onclick="loadPage('siswa/siswa_ekstra_in_kelas.php', this)">Siswa Ekstrakurikuler</a>
        <a id="menu-nilai" onclick="loadPage('nilai/nilai_siswa_in_wali.php', this)">Nilai Siswa Ekstrakurikuler</a>
        <a id="menu-profil" onclick="loadPage('profil/profil_wali_kelas.php', this)">Profil</a>
  ...
  <script>
    ...
    window.onload = function () {
      loadPage("beranda/beranda_wali_kelas.php");
    };
